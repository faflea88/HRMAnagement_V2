...
public void i_update_some_data() {
	SeleniumDriver.getDriver().findElement(By.xpath("//input[@id='initialRows_0_toDelete']")).click();
 ...
 SeleniumDriver.getDriver().findElement(By.xpath("//input[@id='initialRows_0_1']")).sendKeys("3");
 SeleniumDriver.getDriver().findElement(By.xpath("//input[@id='initialRows_0_2']")).sendKeys("3");
 SeleniumDriver.getDriver().findElement(By.xpath("//input[@id='initialRows_0_3']")).sendKeys("3");
 SeleniumDriver.getDriver().findElement(By.xpath("//input[@id='initialRows_0_4']")).sendKeys("3");
 SeleniumDriver.getDriver().findElement(By.xpath("//input[@id='initialRows_0_5']")).sendKeys("3");
 SeleniumDriver.getDriver().findElement(By.xpath("//input[@id='initialRows_0_6']")).sendKeys("3");
 SeleniumDriver.getDriver().findElement(By.xpath("//input[@id='submitSave']")).submit();
